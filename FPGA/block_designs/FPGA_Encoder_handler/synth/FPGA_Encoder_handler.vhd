...
architecture STRUCTURE of FPGA_Encoder_handler is
  ...
  attribute X_INTERFACE_PARAMETER of clk_0 : signal is "XIL_INTERFACENAME CLK.CLK_0, ASSOCIATED_RESET rst_0, CLK_DOMAIN FPGA_Encoder_handler_clk_0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0";
...
begin
counter_nbit_0: component FPGA_Encoder_handler_counter_nbit_0_0
     port map (
      clk => clk_0,
...
encoder_direction_0: component FPGA_Encoder_handler_encoder_direction_0_0
     port map (
      a => a_0,
      b => b_0,
      clk => clk_0,
...
one_shot_0: component FPGA_Encoder_handler_one_shot_0_0
     port map (
      clk => clk_0,
      en => en_0,
