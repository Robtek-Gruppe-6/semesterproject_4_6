...
module FPGA_Motor_handler (
  ...
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN FPGA_Motor_handler_clk_0, ASSOCIATED_RESET rst, INSERT_VIP 0" *)
  input clk;
